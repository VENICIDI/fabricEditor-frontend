...
- **UI Layer（Toolbar / Inspector / Layers）**
...
### Milestone D：图层操作 + 复制粘贴

- 置顶/置底/上移/下移命令化。
- 复制粘贴命令化（AddObjectCommand 或专门 PasteCommand）。

验收：图层变化可撤销重做，复制粘贴可撤销重做。
